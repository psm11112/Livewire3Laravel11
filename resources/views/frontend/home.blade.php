...
<nav class="w-full bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900  z-50">
    ...
    <div  class="mt-1 border-gray-200 shadow-sm bg-gray-50 md:bg-white border-y dark:bg-gray-800 dark:border-gray-600">
        ...
        @if($showMenu)
        <div wire:transition class=" grid max-w-screen-xl px-4 py-5 mx-auto text-gray-900 dark:text-white sm:grid-cols-2 md:px-6">
            <ul>
                <li>
